...
=================   MARIO JUMP   ===============
Olá, esse projeto foi meu primeiro game utilizando HTML, CSS e JavaScript.
...
2.QUANDO MARIO MORRE ELE FAZ ANIMAÇÃO SEMELHANTE DO SUPER NINTENDO E SAI DO CENÁRIO;

=> EN

=================   MARIO JUMP   ===============
Hello, this project was my first game using HTML, CSS and JavaScript.
...
2.WHEN MARIO DIES HE MAKES ANIMATION SIMILAR TO SUPER NINTENDO AND LEAVES THE SCENE;